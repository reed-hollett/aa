...
export default function Footer() {
  return (
    <footer className="pt-24 pb-8 px-6 md:px-10">
      {/* Social + copyright */}
      <div className="text-center text-[14px] text-foreground mb-32 space-y-0">
      ...
      <motion.p
        ...
        className="text-[clamp(2rem,12vw,14rem)] font-normal leading-[0.9] tracking-tighter text-center"
      >
        Atelier Armbruster
      </motion.p>
    </footer>
